...
// ---------------------------------------------------------------------------
// Known brand display names — maps raw site keywords to clean labels.
// Used to generate interest tags without leaking raw domain fragments.
// Covers all categories present in CATEGORY_KEYWORDS.
// ---------------------------------------------------------------------------
...
const KNOWN_BRANDS: Record<string, string> = {
  ...
  'dazn': 'DAZN', 'nowtv': 'Now TV', 'channel4': 'Channel 4',
  'itv': 'ITV', 'bbc': 'BBC iPlayer', 'channel5': 'Channel 5',
  ...
  'whatsapp': 'WhatsApp', 'threads': 'Threads', 'bluesky': 'Bluesky',
  'quora': 'Quora',

  // News & Media
  'cnn': 'CNN', 'guardian': 'The Guardian', 'nytimes': 'New York Times',
  'wsj': 'Wall Street Journal', 'reuters': 'Reuters', 'bloomberg': 'Bloomberg',
  'forbes': 'Forbes', 'theverge': 'The Verge', 'techcrunch': 'TechCrunch',
  'wired': 'Wired', 'dailymail': 'Daily Mail', 'telegraph': 'The Telegraph',
  'independent': 'The Independent', 'mirror': 'The Mirror', 'thesun': 'The Sun',
  'sky': 'Sky News', 'aljazeera': 'Al Jazeera', 'washingtonpost': 'Washington Post',
  'huffpost': 'HuffPost', 'buzzfeed': 'BuzzFeed', 'vice': 'Vice',
  'vox': 'Vox', 'economist': 'The Economist', 'ft': 'Financial Times',
  'newsweek': 'Newsweek',

  // E-Commerce & Shopping
  'amazon': 'Amazon', 'ebay': 'eBay', 'etsy': 'Etsy', 'asos': 'ASOS',
  'shopify': 'Shopify', 'walmart': 'Walmart', 'target': 'Target',
  'bestbuy': 'Best Buy', 'argos': 'Argos', 'currys': 'Currys',
  'johnlewis': 'John Lewis', 'next': 'Next', 'zara': 'Zara', 'hm': 'H&M',
  'nike': 'Nike', 'adidas': 'Adidas', 'shein': 'Shein', 'boohoo': 'Boohoo',
  ...
  'azure': 'Azure', 'docker': 'Docker', 'jira': 'Jira',
  'confluence': 'Confluence', 'notion': 'Notion', 'figma': 'Figma',
  'canva': 'Canva', 'codepen': 'CodePen', 'replit': 'Replit',
  ...
  'ign': 'IGN', 'gamespot': 'GameSpot', 'polygon': 'Polygon',
  'eurogamer': 'Eurogamer', 'pcgamer': 'PC Gamer', 'riotgames': 'Riot Games',
  'blizzard': 'Blizzard', 'ea': 'EA', 'ubisoft': 'Ubisoft',
  ...
  'virginatlantic': 'Virgin Atlantic', 'hotels': 'Hotels.com',
  'hostelworld': 'Hostelworld', 'lonelyplanet': 'Lonely Planet', 'timeout': 'Time Out',
  ...
  'peloton': 'Peloton', 'headspace': 'Headspace', 'calm': 'Calm',
  ...
  'futurelearn': 'FutureLearn', 'openuniversity': 'Open University',
  'chegg': 'Chegg',

  // Search & Productivity
  'google': 'Google', 'bing': 'Bing', 'duckduckgo': 'DuckDuckGo',
  'dropbox': 'Dropbox', 'trello': 'Trello',
  'asana': 'Asana', 'slack': 'Slack', 'zoom': 'Zoom',
};
...
function buildPersona(
  ...
  if (top && second && second[1] >= top[1] * 0.65) {
    ...
    if (compound) {
      return { title: compound.title, emoji: compound.emoji, reason: compound.reason(topCompanyNames) };
    }
  }
  ...
  if (top) {
    ...
    if (single) {
      return { title: single.title, emoji: single.emoji, reason: single.reason(topCompanyNames) };
    }
  }
  ...
  if (hasGoogle && hasMeta) {
    return {
      title: 'The Broadly Tracked User', emoji: '🕸️',
  ...
  return {
    title: 'The General Browser', emoji: '🌐',
...
const SINGLE_PERSONAS: Record<string, {
  ...
  shopping: {
    title: 'The Online Shopper', emoji: '🛍️',
  ...
  socialMedia: {
    title: 'The Social Media Regular', emoji: '📱',
  ...
  video: {
    title: 'The Content Streamer', emoji: '🎬',
  ...
  tech: {
    title: 'The Tech Enthusiast', emoji: '💻',
  ...
  finance: {
    title: 'The Finance Browser', emoji: '💰',
  ...
  travel: {
    title: 'The Travel Planner', emoji: '✈️',
  ...
  food: {
    title: 'The Food & Delivery Fan', emoji: '🍕',
  ...
  health: {
    title: 'The Health-Conscious Browser', emoji: '🏃',
  ...
  education: {
    title: 'The Lifelong Learner', emoji: '📚',
...
const COMPOUND_PERSONAS: Record<string, {
  ...
  'tech+shopping': {
    title: 'The Tech Shopper', emoji: '🖥️',
  ...
  'shopping+socialMedia': {
    title: 'The Social Shopper', emoji: '🛒',
  ...
  'news+tech': {
    title: 'The Tech-Informed Reader', emoji: '🗞️',
  ...
  'travel+shopping': {
    title: 'The Lifestyle Spender', emoji: '🌍',
  ...
  'health+food': {
    title: 'The Wellness Browser', emoji: '🥗',
  ...
  'gaming+video': {
    title: 'The Digital Entertainment Fan', emoji: '🎮',
  ...
  'socialMedia+video': {
    title: 'The Content Browser', emoji: '📺',
  ...
  'finance+shopping': {
    title: 'The Value-Conscious Buyer', emoji: '💳',
  ...
  'education+tech': {
    title: 'The Developer in Training', emoji: '🧑‍💻',
...
function estimateAdValue(scores: Record<string, number>): string {
  ...
  return `$${(avg * 0.8).toFixed(2)}–$${(avg * 1.2).toFixed(2)} CPM`;
}
...
function buildBehavioralInsights(
  ...
  if (totalEvents > 100) {
    const eventLabel = totalEvents >= 1000 ? `${(totalEvents / 1000).toFixed(1)}k` : totalEvents.toString();
...
export function buildFullProfile(
  ...
  // Build interest tags using KNOWN_BRANDS to avoid raw domain fragments
  ...
  const dataValue: DigitalProfile['dataValue'] =
    (scores.finance > 15 || scores.shopping > 20 || scores.travel > 20) && totalEvents > 100 ? 'Very High' :
    (scores.finance > 15 || scores.shopping > 20 || scores.travel > 20) || totalEvents > 50  ? 'High' :
